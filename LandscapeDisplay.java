...
public class LandscapeDisplay {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //add 20 killer agents
        for(int i = 0; i < 20; i++){
            scape.addAgent(new KillerAgent(gen.nextDouble() * scape.getWidth(), gen.nextDouble() * scape.getHeight(), 15));
        }

        // Creates 1000 SocialAgents and 1000 AntiSocialAgents, with radius of 75
